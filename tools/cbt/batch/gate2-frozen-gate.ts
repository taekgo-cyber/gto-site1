// Gate 2 frozen Gate target lock — independent source, not derived from runtime input.
// This file is the explicit frozen constant for BUILD integrity evidence.
// Do not edit without gate approval; hash must match docs/cbt/gate2-targets.txt canonical SHA-256.
export const FROZEN_GATE_TARGET_COUNT = 50;
export const FROZEN_GATE_TARGET_HASH = "8630715E0322C45EF04088BE431A22632399DF41372FE2647C04726559D18F20";
// Canonical ordered list matching docs/cbt/gate2-targets.txt at freeze point.
export const FROZEN_GATE_TARGET_IDS: readonly string[] = [
